-- ============================================================
--   GLA University — SIPP 2026
--   College Admission Management System
--   Pre-Masterclass Assignment — SQL Solutions
--   Author: Krati
-- ============================================================
...
-- ============================================================
-- SECTION 3: SQL QUERY SOLUTIONS (Q1 to Q10)
-- ============================================================

-- Question 1:
-- Display student's full name, department name, and admission status
-- of all students who have applied for admission.
...
-- Question 2:
-- Display student's full name, application date, and department name
-- for every admission application.
...
-- Question 3:
-- Display student's full name, payment amount, payment mode,
-- and payment status.
...
-- Question 4:
-- Display student's full name, document name, and verification status.
...
-- Question 5:
-- Display Student Name, Department Name, Admission Status,
-- Application Date for every application.
...
-- Question 6:
-- Display Student Name, Department Name, Tuition Fee, Amount Paid.
...
-- Question 7:
-- Display names of students whose admission status is 'Approved',
...
-- Question 8:
-- Display Student Name, Department Name, Payment Status, Payment Mode.
...
-- Question 9:
-- Display Student Name, Department Name,
-- Document Verification Status, Admission Status for every student.

SELECT
    CONCAT(s.FirstName, ' ', s.LastName) AS StudentName,
    d.DepartmentName,
    doc.VerificationStatus AS DocumentVerificationStatus,
    a.AdmissionStatus
FROM Students s
JOIN Applications a  ON s.StudentID    = a.StudentID
JOIN Departments d   ON a.DepartmentID = d.DepartmentID
